...
const loadOptions = async (inputValue) =>{
    ...
    try{
        const response = await fetch(`https://api.themoviedb.org/3/search/movie?query=${inputValue}&include_adult=true&language=en-US&page=1&region=US`, options)
